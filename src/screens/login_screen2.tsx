...
// LoginScreen2 Component
export default ({}: LoginScreen2Props) => {
...
const {state, setState} = createState<{
  ...
  return (
    <View style={styles.container}>
      ...
      <Animatible.View style={styles.footer} animation='fadeInUpBig' duration={1500}>
        ...
        <TouchableOpacity
          style={[
            styles.signIn,
            {borderColor: '#009387', borderWidth: 1, backgroundColor: 'white', marginTop:50},
          ]}
          onPress={() => {}}>
